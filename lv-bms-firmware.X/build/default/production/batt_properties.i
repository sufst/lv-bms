...
# 2 "<built-in>" 2
# 1 "batt_properties.c" 2

# 1 "./batt_properties.h" 1
# 34 "./batt_properties.h"
...
bool check_over_current_charge(current_t cell_curr) {
    if (cell_curr > 25 * 1024 || cell_curr < 0){
        return true;
    }
    return false;
}
